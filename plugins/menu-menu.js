...
┃ *< 𝔹𝕆𝕋 𝕆𝔽ℂ E 𝕊𝕌𝔹 𝔹𝕆𝕋 />*
┃≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡┃
┣ ${(conn.user.jid == global.conn.user.jid ? '' : `Jadibot de: https://wa.me/${global.conn.user.jid.split`@`[0]}`) || '*Este é o Bot Oficial*'}
┗━━━━━━━━━━━━━━━━┛
...
┗━━━━━━━━━━━━━━━━┛`.trim();
    ...
    conn.reply(m.chat, '*[❗𝐈𝐍𝐅𝐎❗] O MENU TEM UM ERRO E NÃO FOI POSSIVEL ENVIA-LO, REPORTE AO PROPRIETARIO DO BOT!*', m);
  }
};
